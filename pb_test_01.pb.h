...
#ifndef PROTOBUF_pb_5ftest_5f01_2eproto__INCLUDED
#define PROTOBUF_pb_5ftest_5f01_2eproto__INCLUDED
...
class SchoolClass : public ::google::protobuf::Message {
 public:
  SchoolClass();
  virtual ~SchoolClass();

  SchoolClass(const SchoolClass& from);

  inline SchoolClass& operator=(const SchoolClass& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  SchoolClass* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const SchoolClass& from);
  void MergeFrom(const SchoolClass& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline int class_teacher__size() const;
  inline void clear_class_teacher_();
  static const int kClassTeacherFieldNumber = 1;
  inline const ::Person& class_teacher_(int index) const;
  inline ::Person* mutable_class_teacher_(int index);
  inline ::Person* add_class_teacher_();
  inline const ::google::protobuf::RepeatedPtrField< ::Person >&
      class_teacher_() const;
  inline ::google::protobuf::RepeatedPtrField< ::Person >*
      mutable_class_teacher_();

  // repeated .Person student_ = 2;
  inline int student__size() const;
  inline void clear_student_();
  static const int kStudentFieldNumber = 2;
  inline const ::Person& student_(int index) const;
  inline ::Person* mutable_student_(int index);
  inline ::Person* add_student_();
  inline const ::google::protobuf::RepeatedPtrField< ::Person >&
      student_() const;
  inline ::google::protobuf::RepeatedPtrField< ::Person >*
      mutable_student_();

  // @@protoc_insertion_point(class_scope:SchoolClass)
 private:
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::Person > class_teacher__;
  ::google::protobuf::RepeatedPtrField< ::Person > student__;
  friend void  protobuf_AddDesc_pb_5ftest_5f01_2eproto();
  friend void protobuf_AssignDesc_pb_5ftest_5f01_2eproto();
  friend void protobuf_ShutdownFile_pb_5ftest_5f01_2eproto();
...
// repeated int32 classid = 5;
inline int Person::classid_size() const {
  return classid_.size();
}
inline void Person::clear_classid() {
  classid_.Clear();
}
inline ::google::protobuf::int32 Person::classid(int index) const {
  // @@protoc_insertion_point(field_get:Person.classid)
  return classid_.Get(index);
}
inline void Person::set_classid(int index, ::google::protobuf::int32 value) {
  classid_.Set(index, value);
  // @@protoc_insertion_point(field_set:Person.classid)
}
inline void Person::add_classid(::google::protobuf::int32 value) {
  classid_.Add(value);
  // @@protoc_insertion_point(field_add:Person.classid)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
Person::classid() const {
  // @@protoc_insertion_point(field_list:Person.classid)
  return classid_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
Person::mutable_classid() {
  // @@protoc_insertion_point(field_mutable_list:Person.classid)
  return &classid_;
}
...
// repeated .Person class_teacher_ = 1;
inline int SchoolClass::class_teacher__size() const {
  return class_teacher__.size();
}
inline void SchoolClass::clear_class_teacher_() {
  class_teacher__.Clear();
}
inline const ::Person& SchoolClass::class_teacher_(int index) const {
  // @@protoc_insertion_point(field_get:SchoolClass.class_teacher_)
  return class_teacher__.Get(index);
}
inline ::Person* SchoolClass::mutable_class_teacher_(int index) {
  // @@protoc_insertion_point(field_mutable:SchoolClass.class_teacher_)
  return class_teacher__.Mutable(index);
}
inline ::Person* SchoolClass::add_class_teacher_() {
  // @@protoc_insertion_point(field_add:SchoolClass.class_teacher_)
  return class_teacher__.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::Person >&
SchoolClass::class_teacher_() const {
  // @@protoc_insertion_point(field_list:SchoolClass.class_teacher_)
  return class_teacher__;
}
inline ::google::protobuf::RepeatedPtrField< ::Person >*
SchoolClass::mutable_class_teacher_() {
  // @@protoc_insertion_point(field_mutable_list:SchoolClass.class_teacher_)
  return &class_teacher__;
}

// repeated .Person student_ = 2;
inline int SchoolClass::student__size() const {
  return student__.size();
}
inline void SchoolClass::clear_student_() {
  student__.Clear();
}
inline const ::Person& SchoolClass::student_(int index) const {
  // @@protoc_insertion_point(field_get:SchoolClass.student_)
  return student__.Get(index);
}
inline ::Person* SchoolClass::mutable_student_(int index) {
  // @@protoc_insertion_point(field_mutable:SchoolClass.student_)
  return student__.Mutable(index);
}
inline ::Person* SchoolClass::add_student_() {
  // @@protoc_insertion_point(field_add:SchoolClass.student_)
  return student__.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::Person >&
SchoolClass::student_() const {
  // @@protoc_insertion_point(field_list:SchoolClass.student_)
  return student__;
}
inline ::google::protobuf::RepeatedPtrField< ::Person >*
...
#endif  // PROTOBUF_pb_5ftest_5f01_2eproto__INCLUDED
